...
define("common/js/modules/domUtils/domUtilsModule", [ "angular" ], function(ng) {
    ...
    module.factory("ViewPortService", function($rootScope, $timeout, DomUtilsService, SessionsService) {
        ...
        function adjustViewPortAccordingToOrientation(){
			...
			if (width!=mViewPortWidth){
				mViewPortWidth = width;
				if (GlobalConfig.isMobileApp){ //phone gap mobile app have problems with viewport on android, we use zoom instead
        ...
        function bindViewPortSizeToWindowWidth(){
			...
			updateViewportInfo();
			$timeout(updateViewportInfo, 1000);//sometimes the view port info is not updated imeediatly... 
			onResize();
		}
        function getWindowScroll() {
            var doc = document.documentElement, left = (window.pageXOffset || doc.scrollLeft) - (doc.clientLeft || 0), top = (window.pageYOffset || doc.scrollTop) - (doc.clientTop || 0);
        ...
        function isWideDevice() {
            return getClientWidth() < 500 ? !1 : SessionsService.isMobile() ? window.navigator.userAgent.match(/ipad/i) ? !0 : !1 : !0;
        }
    ...
    module.directive("bsPagination", function($timeout, $rootScope, $stateParams, PathsService, SessionsService) {
        return {
            restrict: "E",
            replace: !0,
            scope: {
            ...
            link: function(scope, element) {
                ...
                function adjustButtonsNumber() {
                    ...
                    if (parent) {
                        var buttonWidth = SessionsService.isMobile() ? 60 : 50, availableWidth = scope.availableWidth || Math.min(800, parent.offsetWidth) - buttonWidth, maxButtons = Math.floor(availableWidth / buttonWidth) - 4;
...
define("common/js/modules/system/systemModule", [ "angular", "../utils/index" ], function(ng) {
    ...
    module.value("SessionInfo", {}), module.factory("SessionsService", function($location, $rootScope, ApiService, LogService, AnalyticsService, LocalStorageService, SettingsService, PathsService, SessionInfo) {
        ...
        function isMobile() {
            return mOsInfo ? mOsInfo.isMobile || GlobalConfig.isMobileApp : void 0;
        }
        function getRegion() {
