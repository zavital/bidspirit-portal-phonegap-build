            ...
            link: function(scope, element) {
                ...
                function adjustButtonsNumber(){
            		...
            		if (parent){
            			...
            			var buttonWidth = SessionsService.isMobile() ? 60 : 50;
            			
            			var availableWidth = scope.availableWidth || (Math.min(800,parent.offsetWidth)-buttonWidth);
            			
            			var maxButtons = Math.floor(availableWidth/buttonWidth) -4;
                    	
                    	if (maxButtons<3){
                    		maxButtons = 3;
                    	}
                    	
                    	scope.maxButtons = maxButtons;
            		}                	
            	}
                function setHrefs() {
