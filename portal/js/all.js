...
define("common/js/modules/domUtils/domUtilsModule", [ "angular" ], function(ng) {
    ...
    module.directive("bsPagination", function($timeout, $rootScope, $stateParams, PathsService, OsInfoService) {
        return {
            restrict: "E",
            replace: !0,
            scope: {
            ...
            link: function(scope, element) {
                ...
                function getMaxButtonsNumber() {
                    ...
                    if (parent) {
                        var buttonWidth = OsInfoService.isMobile() ? 60 : 50, availableWidth = scope.availableWidth || Math.min(800, parent.offsetWidth) - buttonWidth, maxButtons = Math.floor(availableWidth / buttonWidth) - 1;
