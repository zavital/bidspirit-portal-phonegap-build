...
define("common/js/modules/domUtils/domUtilsModule", [ "angular" ], function(ng) {
    ...
    module.factory("ViewPortService", function($rootScope, $timeout, DomUtilsService, OsInfoService) {
        ...
        function updateViewportInfo() {
            ...
            mViewPortInfo.clientWidth = getClientWidth(), mViewPortInfo.maxWidth = getMaxWidth(), 
    ...
    module.directive("bsWidthLimitDirective", function($parse, $timeout, ViewPortService) {
        return {
            restrict: "A",
            scope: {
        ...
        return {
            ...
            link: function(scope, element) {
                ...
                function getMaxButtonsNumber() {
                    ...
                    if (parent) {
                        var buttonWidth = $rootScope.viewPort.mobileMedia ? 60 : 50, availableWidth = scope.availableWidth || Math.min(800, parent.offsetWidth) - buttonWidth, maxButtons = Math.floor(availableWidth / buttonWidth) - 1;
                ...
                function onDataChange(newValue, oldValue) {
                    ...
                    $stateParams.page && scope.pagesData.currentPage != $stateParams.page && (window.location.href = scope.baseHref + scope.pagesData.currentPage), 
                    updateDisplay();
                }
                $rootScope.$on("viewPort.windowSizeChanged", function() {
                    updateDisplay(), $timeout(updateDisplay, 100);
                }), setBaseHref(), scope.$watchCollection("pagesData", onDataChange), updateDisplay();
            },
...
define("common/js/modules/system/systemModule", [ "angular", "../utils/index" ], function(ng) {
    ...
    module.factory("CssLoaderService", function($q, LocalStorageService) {
        ...
        function loadCss(cssPath) {
            ...
            GlobalConfig.isMobileApp || (cssPath += "?v=" + GlobalConfig.cssCacheVersion + "&load=" + getCssLoadVersion()), 
    ...
    module.value("SessionInfo", {}), module.factory("SessionsService", function($location, $rootScope, ApiService, LogService, AnalyticsService, LocalStorageService, SettingsService, PathsService, SessionInfo, OsInfoService) {
...
define("common/js/modules/paths/pathsModule", [ "angular" ], function(ng) {
    ...
    module.factory("PathsService", function($rootScope, $log, $modal, $state, $timeout, SessionInfo, SettingsService) {
        ...
        function validateHttps() {
            return GlobalConfig.isMobileApp ? !0 : "dev" == SettingsService.get("envName") || "https:" == window.location.protocol || $rootScope.searchAgentRequest ? !0 : (window.location = window.location.href.replace("http:", "https:"), 
            !1);
        }
...
define("common/js/modules/log/logModule", [ "angular" ], function(ng) {
    ...
    module.factory("LogService", function($rootScope, $log, SettingsService, SessionInfo) {
        ...
        function logError(errorStr, e) {
            try {
                ...
                $rootScope.debug(errorStr), e && (errorToLog += exceptionMessage(e)), $log.warn(errorToLog), 
                errorToLog = "(" + SettingsService.secondsSinceStart() + ") " + errorToLog, 5 > mLoggedErrors && (mLoggedErrors++, 
                logEvent({
                    eventType: "jsError",
                    message: errorToLog
                }));
    ...
    module.factory("AnalyticsService", function(Analytics, LogService, LocalStorageService) {
        function trackEvent(category, action, label, options) {
            if (!isBidspiritEmployee) {
                ...
                try {
                    ...
                    GlobalConfig.isMobileApp && window.analytics ? window.analytics.trackEvent(category, action, label) : Analytics.trackEvent(category, action, label);
                } catch (e) {
        ...
        function trackPage(page) {
            isBidspiritEmployee || (GlobalConfig.isMobileApp && window.analytics ? window.analytics.trackView(page) : Analytics.trackPage(page));
        }
...
define("portal/js/modules/main/portalMainModule", [ "angular" ], function(ng) {
    ...
    module.controller("MainController", [ "$scope", "$rootScope", "$state", "$timeout", "ArraysService", "AnalyticsService", "I18nService", "CssLoaderService", "PathsService", "DomUtilsService", "LocalStorageService", "OsInfoService", "SessionsService", "LogService", "SettingsService", "ViewPortService", "DialogsService", "HeartBitService", "StructuredDataService", "PortalStates", "PortalInfoService", "PortalTextsService", "LegalApprovalService", function($scope, $rootScope, $state, $timeout, ArraysService, AnalyticsService, I18nService, CssLoaderService, PathsService, DomUtilsService, LocalStorageService, OsInfoService, SessionsService, LogService, SettingsService, ViewPortService, DialogsService, HeartBitService, StructuredDataService, PortalStates, PortalInfoService, PortalTextsService, LegalApprovalService) {
        function initDebug() {
            ...
            }, $rootScope.debug("debug init"), AnalyticsService.trackEvent("init", GlobalConfig.isMobileApp ? "mobile" : "web");
        }
        function onInit() {
            "loaded" != $rootScope.loadState && ($rootScope.loadState = "loaded", $rootScope.isIe8 = OsInfoService.isIe8(), 
            $rootScope.isMobile = OsInfoService.isMobile(), PortalStates.init(), PortalTextsService.init(), 
        ...
        function portalI18nResoucePath(lang) {
            ...
            var pathBase = OsInfoService.isOldIe() ? GlobalConfig.apiBase : GlobalConfig.cachedApiBase;
    ...
    module.factory("PortalInfoService", function($q, $rootScope, $interval, $timeout, ApiService, ArraysService, I18nService, SettingsService, StringsService, LocalStorageService, LogService, DateUtilsService, SessionsService, CachedApiService) {
        ...
        function init(region) {
            ...
            var cachedDataPromise = loadLastStoredPortalInfo(region || "ALL"), freshDataPromise = loadForRegion(region, !1).success(function(portalInfo) {
                SessionsService.setSessionInfo(portalInfo.sessionInfo);
            });
        ...
        function loadForRegion(region, includeOldAuctions) {
            ...
            return ApiService.callApi("/portal/getPortalInfo", params).success(function(portalInfo) {
                LocalStorageService.store("portalInfo_" + (region || "ALL"), JSON.stringify(portalInfo)), 
    ...
    module.factory("PortalTextsService", function($rootScope, SessionsService, OsInfoService, SettingsService, DomUtilsService, I18nService) {
        function init() {
    ...
    module.factory("HeartBitService", function($rootScope, $interval, $log, ApiService, SettingsService, DialogsService, I18nService, SessionsService, PortalInfoService) {
        ...
        function heartBeat() {
            ApiService.callApi("/portal/heartBeat").success(function(heartBeatResponse) {
                ...
                settings.cacheVersions = newCacheVersions, GlobalConfig.isMobileApp ? !mAppUpdateMessageDisplayed && GlobalConfig.appVersion < heartBeatResponse.requiredMobileAppVersion && (DialogsService.showAlert("warning_new_mobile_required"), 
        ...
        function init() {
            $rootScope.searchAgentRequest || $interval(heartBeat, 1e3 * mHeartBitRate);
        }
...
define("portal/js/modules/auctions/catalogs/list/catalogListModule", [ "angular" ], function(ng) {
    ...
    module.controller("CatalogListController", [ "$rootScope", "$scope", "$timeout", "$state", "$stateParams", "AnalyticsService", "ArraysService", "LocalStorageService", "I18nService", "DomUtilsService", "CatalogUtilsService", "StructuredDataService", "PortalInfoService", "CatalogsService", "CatalogAccountService", function($rootScope, $scope, $timeout, $state, $stateParams, AnalyticsService, ArraysService, LocalStorageService, I18nService, DomUtilsService, CatalogUtilsService, StructuredDataService, PortalInfoService, CatalogsService, CatalogAccountService) {
        ...
        function init() {
            ...
            lastSceneIsOfPageFromThisAuction(navState) ? ($scope.displayeItemsLoader = !0, loadNavStateInfo(navState), 
            $timeout(function() {
                $scope.displayeItemsLoader = !1;
            }, 400)) : PortalInfoService.loadAuction($stateParams.auctionId).then(function(auction) {
            ...
            link: function(scope, element) {
                function adjustWidth() {
                    ...
                    if (parent) {
                        ...
                        scope.lifted = !0, element.css({
                            width: scope.availableWidth + "px"
                        })) : (scope.availableWidth = availableWidth - 50, scope.lifted = !1, element.removeClass("lifted"));
                    }
                }
...
define("portal/js/modules/auctions/catalogs/lotPage/lotPageModule", [ "angular" ], function(ng) {
    ...
    module.controller("LotPageController", [ "$scope", "$state", "$stateParams", "$modal", "$rootScope", "$timeout", "$window", "AnalyticsService", "StringsService", "PathsService", "I18nService", "PortalAuthService", "PortalInfoService", "DomUtilsService", "CatalogUtilsService", "StructuredDataService", "PopupsService", "AccountService", "CatalogsService", "CatalogAccountService", "MyAccountService", function($scope, $state, $stateParams, $modal, $rootScope, $timeout, $window, AnalyticsService, StringsService, PathsService, I18nService, PortalAuthService, PortalInfoService, DomUtilsService, CatalogUtilsService, StructuredDataService, PopupsService, AccountService, CatalogsService, CatalogAccountService, MyAccountService) {
        ...
        function loadItem() {
            ...
            }), $rootScope.$on("i18n.languageChanged", initTexts), $rootScope.$on("viewPort.windowSizeChanged", function() {
    ...
    module.directive("bsLotPageImages", function($rootScope, $state, $modal, PathsService, ArraysService, CloudinaryService, ViewPortService) {
        return {
            restrict: "E",
            replace: !0,
            scope: {
...
define("portal/js/modules/components/componentsModule", [ "angular" ], function(ng) {
    ...
    module.directive("bsHousesCarousel", function($window, $timeout, $interval, $rootScope, PathsService, PortalInfoService, ArraysService, CloudinaryService, OsInfoService, ViewPortService) {
        return {
            ...
            link: function(scope, element) {
                ...
                (OsInfoService.isIe8() || OsInfoService.isMobile()) && (mAnimationDisabled = !0), 
    ...
    module.directive("ie8Warning", function($compile, $rootScope, I18nService, OsInfoService) {
        return {
            restrict: "A",
            replace: !0,
            link: function(scope, element) {
                ...
                scope.ie8WarningVisible = OsInfoService.isIe8(), $rootScope.$on("i18n.languageChanged", setHtml), 
                setHtml();
            },
...
}), define("portal/js/modules/components/index", [ "./componentsModule", "./houseCarouselDirective", "./ie8WarningDirective", "./contentLoaderDirective", "./pageFooterDirective", "./popupsService", "./structuredDataService", "./upperPartDirective" ], function() {}), 
define("portal/js/modules/navigation/navigationModule", [ "angular" ], function(ng) {
    ...
    module.controller("UpperNavigationController", [ "$scope", "$rootScope", "$window", "$state", "I18nService", "LocalStorageService", "ViewPortService", "OsInfoService", "PortalAuthService", "PortalInfoService", "SearchService", function($scope, $rootScope, $window, $state, I18nService, LocalStorageService, ViewPortService, OsInfoService, PortalAuthService, PortalInfoService, SearchService) {
        function checkMobileSearchVisible() {
            $scope.data.showMobileSearch = !1, !$scope.data.mobileMenuOn && "search" != $state.current.url && ViewPortService.clientWidth() <= 991 && new Date().getTime() - $scope.data.lastSceneStart > 3e3 && ViewPortService.getWindowScroll().top > 500 && ($scope.data.showMobileSearch = !0);
        }
        $scope.data = {
            mobileMenuOn: !1,
            showMobileSearch: !1,
            ...
            OsInfoService.isMobile() && SearchService.gotoSearchScene();
    ...
    module.factory("AppSiteWinodwsService", function($rootScope, StringsService, I18nService, PortalAuthService) {
        ...
        function openAuctionSiteWindow(auction, noAutoLogin, lot) {
            if (auction) {
                ...
                GlobalConfig.isMobileApp ? tryToaunchWithPuffin(url) : window.open(url, "_system"), 
                token && PortalAuthService.createTokenForAppSite(auction.houseId, token);
            }
        }
        function tryToaunchWithPuffin(url) {
            if ("undefined" == typeof device) return void window.open(url, "_system");
            var scheme;
            "iOS" === device.platform ? scheme = "puffin://" : "Android" === device.platform && (scheme = "com.cloudmosa.puffin"), 
