...
define("portal/js/modules/portalModules", [ "angular", "commonModules", "./main/index", "./auth/index", "./userDetails/index", "./alerts/index", "./info/index", "./auctions/index", "./houses/index", "./account/index", "./nudges/index", "./components/index", "./navigation/index" ], function(ng) {
    ...
    return angular.module("app", [  "ngAnimate", "ngUpload", "angular-google-analytics", "commonModules", "app.portalModules", "app.externals", "ui.router", "ui.bootstrap" ]).config(function($httpProvider,$locationProvider, AnalyticsProvider) {
        ...
        $templateCache.put("/portal/templates/auctions/catalogs/list/catalogItems.html?0.419", '<div class="list" ng-class="{\'mobile-list\':viewPort.mobileMedia}"> {{viewPort | json}} <div class="row">  <div class="item" itemscope itemtype="http://schema.org/Product" bs-current-direction ng-repeat="lot in pagesData.pageItems" ng-class="{\'pc-item\':viewPort.isWideDevice,\'mobile-item\':!viewPort.isWideDevice}" bs-scroll-on="lot.id == scrollTo" > <a  itemprop="url"  class="link" ng-href="#!/lotPage/source/catalog/auction/{{lot.auctionId}}/lot/{{lot.id}}" > <div  ng-if="viewPort.isWideDevice"     ng-include src="\'auctions/catalogs/list/catalogItemWide\' | appTemplate" class="frame"> </div> <div  ng-if="!viewPort.isWideDevice" ng-include src="\'auctions/catalogs/list/catalogItemNarrow\' | appTemplate"> </div> </a> <bs-lot-favorite-flag lot="lot"></bs-lot-favorite-flag> </div> <div class="clearfix"></div> </div>   <div class="clearfix"></div> </div>  '), 
